...
namespace productApp.Controllers
{
    public class EntreprisesController : Controller
    {
        ...
        public EntreprisesController(productAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,EntrepriseLogoURL,NomEntreprise,Discription")] Entreprise entreprise)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EntrepriseLogoURL,NomEntreprise,Discription")] Entreprise entreprise)
        {
            if (id != entreprise.Id)
            {
                return NotFound();
